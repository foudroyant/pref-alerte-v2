...
import 'pricing_set_model.dart';
export 'pricing_set_model.dart';

class PricingSetWidget extends StatefulWidget {
  const PricingSetWidget({super.key});

  @override
  State<PricingSetWidget> createState() => _PricingSetWidgetState();
}

class _PricingSetWidgetState extends State<PricingSetWidget> {
  late PricingSetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PricingSetModel());
